<template>
  <div class="material-design-icon" id="dna-icon" role="img" aria-labelledby="dna-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="dna-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "dna-icon",
    data () {
      let iconTitle = this.title ? this.title : "Dna icon"
