<template>
  <div class="material-design-icon" id="network-question-icon" role="img" aria-labelledby="network-question-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="network-question-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "network-question-icon",
    data () {
      let iconTitle = this.title ? this.title : "Network question icon"
