<template>
  <div class="material-design-icon" id="mixcloud-icon" role="img" aria-labelledby="mixcloud-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="mixcloud-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "mixcloud-icon",
    data () {
      let iconTitle = this.title ? this.title : "Mixcloud icon"
