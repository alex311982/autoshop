<template>
  <div class="material-design-icon" id="file-pdf-box-icon" role="img" aria-labelledby="file-pdf-box-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="file-pdf-box-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "File pdf box icon"
