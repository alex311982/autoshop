<template>
  <div class="material-design-icon" id="tag-plus-icon" role="img" aria-labelledby="tag-plus-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="tag-plus-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "tag-plus-icon",
    data () {
      let iconTitle = this.title ? this.title : "Tag plus icon"
