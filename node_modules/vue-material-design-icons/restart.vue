<template>
  <div class="material-design-icon" id="restart-icon" role="img" aria-labelledby="restart-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="restart-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "restart-icon",
    data () {
      let iconTitle = this.title ? this.title : "Restart icon"
