<template>
  <div class="material-design-icon" id="cart-off-icon" role="img" aria-labelledby="cart-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="cart-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "cart-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Cart off icon"
