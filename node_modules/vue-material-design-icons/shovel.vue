<template>
  <div class="material-design-icon" id="shovel-icon" role="img" aria-labelledby="shovel-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="shovel-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "shovel-icon",
    data () {
      let iconTitle = this.title ? this.title : "Shovel icon"
