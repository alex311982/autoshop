<template>
  <div class="material-design-icon" id="projector-icon" role="img" aria-labelledby="projector-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="projector-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "projector-icon",
    data () {
      let iconTitle = this.title ? this.title : "Projector icon"
