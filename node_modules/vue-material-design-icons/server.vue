<template>
  <div class="material-design-icon" id="server-icon" role="img" aria-labelledby="server-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="server-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "server-icon",
    data () {
      let iconTitle = this.title ? this.title : "Server icon"
