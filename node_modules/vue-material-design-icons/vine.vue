<template>
  <div class="material-design-icon" id="vine-icon" role="img" aria-labelledby="vine-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="vine-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "vine-icon",
    data () {
      let iconTitle = this.title ? this.title : "Vine icon"
