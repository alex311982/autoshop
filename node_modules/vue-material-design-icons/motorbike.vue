<template>
  <div class="material-design-icon" id="motorbike-icon" role="img" aria-labelledby="motorbike-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="motorbike-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "motorbike-icon",
    data () {
      let iconTitle = this.title ? this.title : "Motorbike icon"
