<template>
  <div class="material-design-icon" id="target-icon" role="img" aria-labelledby="target-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="target-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "target-icon",
    data () {
      let iconTitle = this.title ? this.title : "Target icon"
