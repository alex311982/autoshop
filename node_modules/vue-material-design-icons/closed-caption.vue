<template>
  <div class="material-design-icon" id="closed-caption-icon" role="img" aria-labelledby="closed-caption-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="closed-caption-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Closed caption icon"
