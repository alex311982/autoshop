<template>
  <div class="material-design-icon" id="qqchat-icon" role="img" aria-labelledby="qqchat-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="qqchat-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "qqchat-icon",
    data () {
      let iconTitle = this.title ? this.title : "Qqchat icon"
