<template>
  <div class="material-design-icon" id="ribbon-icon" role="img" aria-labelledby="ribbon-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="ribbon-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "ribbon-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ribbon icon"
