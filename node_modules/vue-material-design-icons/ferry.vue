<template>
  <div class="material-design-icon" id="ferry-icon" role="img" aria-labelledby="ferry-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="ferry-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "ferry-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ferry icon"
