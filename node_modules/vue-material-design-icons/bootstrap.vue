<template>
  <div class="material-design-icon" id="bootstrap-icon" role="img" aria-labelledby="bootstrap-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="bootstrap-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "bootstrap-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bootstrap icon"
