<template>
  <div class="material-design-icon" id="timer-off-icon" role="img" aria-labelledby="timer-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="timer-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "timer-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Timer off icon"
