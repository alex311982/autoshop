<template>
  <div class="material-design-icon" id="dropbox-icon" role="img" aria-labelledby="dropbox-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="dropbox-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "dropbox-icon",
    data () {
      let iconTitle = this.title ? this.title : "Dropbox icon"
