<template>
  <div class="material-design-icon" id="speaker-wireless-icon" role="img" aria-labelledby="speaker-wireless-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="speaker-wireless-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Speaker wireless icon"
