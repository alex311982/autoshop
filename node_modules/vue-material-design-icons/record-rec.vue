<template>
  <div class="material-design-icon" id="record-rec-icon" role="img" aria-labelledby="record-rec-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="record-rec-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Record rec icon"
