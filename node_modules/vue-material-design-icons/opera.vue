<template>
  <div class="material-design-icon" id="opera-icon" role="img" aria-labelledby="opera-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="opera-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "opera-icon",
    data () {
      let iconTitle = this.title ? this.title : "Opera icon"
