<template>
  <div class="material-design-icon" id="dots-horizontal-circle-icon" role="img" aria-labelledby="dots-horizontal-circle-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="dots-horizontal-circle-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Dots horizontal circle icon"
