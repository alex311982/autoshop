<template>
  <div class="material-design-icon" id="twitter-box-icon" role="img" aria-labelledby="twitter-box-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="twitter-box-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Twitter box icon"
