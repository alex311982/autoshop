<template>
  <div class="material-design-icon" id="eraser-icon" role="img" aria-labelledby="eraser-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="eraser-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "eraser-icon",
    data () {
      let iconTitle = this.title ? this.title : "Eraser icon"
