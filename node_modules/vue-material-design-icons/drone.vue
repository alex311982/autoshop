<template>
  <div class="material-design-icon" id="drone-icon" role="img" aria-labelledby="drone-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="drone-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "drone-icon",
    data () {
      let iconTitle = this.title ? this.title : "Drone icon"
