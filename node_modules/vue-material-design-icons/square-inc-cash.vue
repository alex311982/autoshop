<template>
  <div class="material-design-icon" id="square-inc-cash-icon" role="img" aria-labelledby="square-inc-cash-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="square-inc-cash-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Square inc cash icon"
