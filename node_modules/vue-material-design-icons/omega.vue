<template>
  <div class="material-design-icon" id="omega-icon" role="img" aria-labelledby="omega-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="omega-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "omega-icon",
    data () {
      let iconTitle = this.title ? this.title : "Omega icon"
