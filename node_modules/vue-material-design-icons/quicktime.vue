<template>
  <div class="material-design-icon" id="quicktime-icon" role="img" aria-labelledby="quicktime-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="quicktime-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "quicktime-icon",
    data () {
      let iconTitle = this.title ? this.title : "Quicktime icon"
