<template>
  <div class="material-design-icon" id="alert-decagram-icon" role="img" aria-labelledby="alert-decagram-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="alert-decagram-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "alert-decagram-icon",
    data () {
      let iconTitle = this.title ? this.title : "Alert decagram icon"
