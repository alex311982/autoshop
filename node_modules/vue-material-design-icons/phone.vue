<template>
  <div class="material-design-icon" id="phone-icon" role="img" aria-labelledby="phone-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="phone-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "phone-icon",
    data () {
      let iconTitle = this.title ? this.title : "Phone icon"
