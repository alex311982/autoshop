<template>
  <div class="material-design-icon" id="radar-icon" role="img" aria-labelledby="radar-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="radar-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "radar-icon",
    data () {
      let iconTitle = this.title ? this.title : "Radar icon"
