<template>
  <div class="material-design-icon" id="cannabis-icon" role="img" aria-labelledby="cannabis-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="cannabis-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "cannabis-icon",
    data () {
      let iconTitle = this.title ? this.title : "Cannabis icon"
