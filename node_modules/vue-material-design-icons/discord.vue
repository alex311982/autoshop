<template>
  <div class="material-design-icon" id="discord-icon" role="img" aria-labelledby="discord-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="discord-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "discord-icon",
    data () {
      let iconTitle = this.title ? this.title : "Discord icon"
