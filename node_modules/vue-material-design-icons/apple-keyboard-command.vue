<template>
  <div class="material-design-icon" id="apple-keyboard-command-icon" role="img" aria-labelledby="apple-keyboard-command-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="apple-keyboard-command-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Apple keyboard command icon"
