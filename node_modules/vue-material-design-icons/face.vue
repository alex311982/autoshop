<template>
  <div class="material-design-icon" id="face-icon" role="img" aria-labelledby="face-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="face-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "face-icon",
    data () {
      let iconTitle = this.title ? this.title : "Face icon"
