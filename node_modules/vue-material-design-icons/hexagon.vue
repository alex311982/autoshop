<template>
  <div class="material-design-icon" id="hexagon-icon" role="img" aria-labelledby="hexagon-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="hexagon-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "hexagon-icon",
    data () {
      let iconTitle = this.title ? this.title : "Hexagon icon"
