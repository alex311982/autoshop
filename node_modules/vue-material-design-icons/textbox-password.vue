<template>
  <div class="material-design-icon" id="textbox-password-icon" role="img" aria-labelledby="textbox-password-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="textbox-password-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Textbox password icon"
