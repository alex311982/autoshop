<template>
  <div class="material-design-icon" id="set-all-icon" role="img" aria-labelledby="set-all-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="set-all-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "set-all-icon",
    data () {
      let iconTitle = this.title ? this.title : "Set all icon"
