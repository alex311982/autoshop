<template>
  <div class="material-design-icon" id="weather-night-icon" role="img" aria-labelledby="weather-night-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="weather-night-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Weather night icon"
