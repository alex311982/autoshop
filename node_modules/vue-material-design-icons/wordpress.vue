<template>
  <div class="material-design-icon" id="wordpress-icon" role="img" aria-labelledby="wordpress-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="wordpress-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "wordpress-icon",
    data () {
      let iconTitle = this.title ? this.title : "Wordpress icon"
