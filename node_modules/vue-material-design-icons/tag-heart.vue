<template>
  <div class="material-design-icon" id="tag-heart-icon" role="img" aria-labelledby="tag-heart-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="tag-heart-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "tag-heart-icon",
    data () {
      let iconTitle = this.title ? this.title : "Tag heart icon"
