<template>
  <div class="material-design-icon" id="robot-icon" role="img" aria-labelledby="robot-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="robot-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "robot-icon",
    data () {
      let iconTitle = this.title ? this.title : "Robot icon"
