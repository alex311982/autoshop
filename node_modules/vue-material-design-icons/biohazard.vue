<template>
  <div class="material-design-icon" id="biohazard-icon" role="img" aria-labelledby="biohazard-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="biohazard-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "biohazard-icon",
    data () {
      let iconTitle = this.title ? this.title : "Biohazard icon"
