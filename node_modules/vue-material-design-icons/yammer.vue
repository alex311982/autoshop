<template>
  <div class="material-design-icon" id="yammer-icon" role="img" aria-labelledby="yammer-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="yammer-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "yammer-icon",
    data () {
      let iconTitle = this.title ? this.title : "Yammer icon"
