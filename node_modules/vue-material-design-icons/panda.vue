<template>
  <div class="material-design-icon" id="panda-icon" role="img" aria-labelledby="panda-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="panda-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "panda-icon",
    data () {
      let iconTitle = this.title ? this.title : "Panda icon"
