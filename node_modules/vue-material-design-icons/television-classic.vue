<template>
  <div class="material-design-icon" id="television-classic-icon" role="img" aria-labelledby="television-classic-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="television-classic-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Television classic icon"
