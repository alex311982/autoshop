<template>
  <div class="material-design-icon" id="paw-icon" role="img" aria-labelledby="paw-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="paw-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "paw-icon",
    data () {
      let iconTitle = this.title ? this.title : "Paw icon"
