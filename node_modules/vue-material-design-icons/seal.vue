<template>
  <div class="material-design-icon" id="seal-icon" role="img" aria-labelledby="seal-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="seal-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "seal-icon",
    data () {
      let iconTitle = this.title ? this.title : "Seal icon"
