<template>
  <div class="material-design-icon" id="dribbble-box-icon" role="img" aria-labelledby="dribbble-box-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="dribbble-box-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Dribbble box icon"
