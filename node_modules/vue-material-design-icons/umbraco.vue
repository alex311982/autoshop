<template>
  <div class="material-design-icon" id="umbraco-icon" role="img" aria-labelledby="umbraco-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="umbraco-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "umbraco-icon",
    data () {
      let iconTitle = this.title ? this.title : "Umbraco icon"
