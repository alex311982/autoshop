<template>
  <div class="material-design-icon" id="wan-icon" role="img" aria-labelledby="wan-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="wan-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "wan-icon",
    data () {
      let iconTitle = this.title ? this.title : "Wan icon"
