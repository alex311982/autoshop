<template>
  <div class="material-design-icon" id="nuke-icon" role="img" aria-labelledby="nuke-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="nuke-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "nuke-icon",
    data () {
      let iconTitle = this.title ? this.title : "Nuke icon"
