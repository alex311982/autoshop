<template>
  <div class="material-design-icon" id="donkey-icon" role="img" aria-labelledby="donkey-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="donkey-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "donkey-icon",
    data () {
      let iconTitle = this.title ? this.title : "Donkey icon"
