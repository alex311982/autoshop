<template>
  <div class="material-design-icon" id="sitemap-icon" role="img" aria-labelledby="sitemap-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="sitemap-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "sitemap-icon",
    data () {
      let iconTitle = this.title ? this.title : "Sitemap icon"
