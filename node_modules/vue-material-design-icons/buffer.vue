<template>
  <div class="material-design-icon" id="buffer-icon" role="img" aria-labelledby="buffer-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="buffer-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "buffer-icon",
    data () {
      let iconTitle = this.title ? this.title : "Buffer icon"
