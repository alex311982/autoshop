<template>
  <div class="material-design-icon" id="glass-tulip-icon" role="img" aria-labelledby="glass-tulip-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="glass-tulip-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Glass tulip icon"
