<template>
  <div class="material-design-icon" id="clock-icon" role="img" aria-labelledby="clock-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="clock-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "clock-icon",
    data () {
      let iconTitle = this.title ? this.title : "Clock icon"
