<template>
  <div class="material-design-icon" id="medium-icon" role="img" aria-labelledby="medium-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="medium-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "medium-icon",
    data () {
      let iconTitle = this.title ? this.title : "Medium icon"
