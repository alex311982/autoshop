<template>
  <div class="material-design-icon" id="saxophone-icon" role="img" aria-labelledby="saxophone-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="saxophone-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "saxophone-icon",
    data () {
      let iconTitle = this.title ? this.title : "Saxophone icon"
