<template>
  <div class="material-design-icon" id="hops-icon" role="img" aria-labelledby="hops-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="hops-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "hops-icon",
    data () {
      let iconTitle = this.title ? this.title : "Hops icon"
