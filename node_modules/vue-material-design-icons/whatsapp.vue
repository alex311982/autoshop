<template>
  <div class="material-design-icon" id="whatsapp-icon" role="img" aria-labelledby="whatsapp-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="whatsapp-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "whatsapp-icon",
    data () {
      let iconTitle = this.title ? this.title : "Whatsapp icon"
