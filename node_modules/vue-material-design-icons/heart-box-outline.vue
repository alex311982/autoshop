...
<script>
  export default {
    name: "heart-box-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Heart box outline icon"
