<template>
  <div class="material-design-icon" id="account-convert-icon" role="img" aria-labelledby="account-convert-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="account-convert-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Account convert icon"
