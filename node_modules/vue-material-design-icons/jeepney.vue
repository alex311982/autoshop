<template>
  <div class="material-design-icon" id="jeepney-icon" role="img" aria-labelledby="jeepney-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="jeepney-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "jeepney-icon",
    data () {
      let iconTitle = this.title ? this.title : "Jeepney icon"
