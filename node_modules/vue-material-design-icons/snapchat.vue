<template>
  <div class="material-design-icon" id="snapchat-icon" role="img" aria-labelledby="snapchat-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="snapchat-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "snapchat-icon",
    data () {
      let iconTitle = this.title ? this.title : "Snapchat icon"
