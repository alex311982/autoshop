<template>
  <div class="material-design-icon" id="bug-icon" role="img" aria-labelledby="bug-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="bug-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "bug-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bug icon"
