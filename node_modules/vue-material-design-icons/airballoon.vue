<template>
  <div class="material-design-icon" id="airballoon-icon" role="img" aria-labelledby="airballoon-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="airballoon-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Airballoon icon"
