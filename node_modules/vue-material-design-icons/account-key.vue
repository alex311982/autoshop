<template>
  <div class="material-design-icon" id="account-key-icon" role="img" aria-labelledby="account-key-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="account-key-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Account key icon"
