<template>
  <div class="material-design-icon" id="grease-pencil-icon" role="img" aria-labelledby="grease-pencil-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="grease-pencil-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Grease pencil icon"
