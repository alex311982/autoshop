<template>
  <div class="material-design-icon" id="github-face-icon" role="img" aria-labelledby="github-face-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="github-face-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Github face icon"
