<template>
  <div class="material-design-icon" id="ev-station-icon" role="img" aria-labelledby="ev-station-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="ev-station-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ev station icon"
