<template>
  <div class="material-design-icon" id="music-off-icon" role="img" aria-labelledby="music-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="music-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "music-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Music off icon"
