<template>
  <div class="material-design-icon" id="slack-icon" role="img" aria-labelledby="slack-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="slack-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "slack-icon",
    data () {
      let iconTitle = this.title ? this.title : "Slack icon"
