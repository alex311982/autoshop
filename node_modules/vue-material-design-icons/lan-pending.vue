<template>
  <div class="material-design-icon" id="lan-pending-icon" role="img" aria-labelledby="lan-pending-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="lan-pending-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Lan pending icon"
