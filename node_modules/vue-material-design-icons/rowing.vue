<template>
  <div class="material-design-icon" id="rowing-icon" role="img" aria-labelledby="rowing-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="rowing-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "rowing-icon",
    data () {
      let iconTitle = this.title ? this.title : "Rowing icon"
