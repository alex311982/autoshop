<template>
  <div class="material-design-icon" id="emoticon-icon" role="img" aria-labelledby="emoticon-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="emoticon-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "emoticon-icon",
    data () {
      let iconTitle = this.title ? this.title : "Emoticon icon"
