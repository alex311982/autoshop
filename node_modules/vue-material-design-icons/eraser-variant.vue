<template>
  <div class="material-design-icon" id="eraser-variant-icon" role="img" aria-labelledby="eraser-variant-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="eraser-variant-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "eraser-variant-icon",
    data () {
      let iconTitle = this.title ? this.title : "Eraser variant icon"
