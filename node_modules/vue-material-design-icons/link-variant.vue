<template>
  <div class="material-design-icon" id="link-variant-icon" role="img" aria-labelledby="link-variant-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="link-variant-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Link variant icon"
