<template>
  <div class="material-design-icon" id="coin-icon" role="img" aria-labelledby="coin-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="coin-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "coin-icon",
    data () {
      let iconTitle = this.title ? this.title : "Coin icon"
