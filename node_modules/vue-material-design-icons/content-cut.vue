<template>
  <div class="material-design-icon" id="content-cut-icon" role="img" aria-labelledby="content-cut-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="content-cut-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Content cut icon"
