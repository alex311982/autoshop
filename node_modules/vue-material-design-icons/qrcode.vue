<template>
  <div class="material-design-icon" id="qrcode-icon" role="img" aria-labelledby="qrcode-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="qrcode-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "qrcode-icon",
    data () {
      let iconTitle = this.title ? this.title : "Qrcode icon"
