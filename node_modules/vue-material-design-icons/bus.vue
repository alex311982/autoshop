<template>
  <div class="material-design-icon" id="bus-icon" role="img" aria-labelledby="bus-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="bus-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "bus-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bus icon"
