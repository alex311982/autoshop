<template>
  <div class="material-design-icon" id="tor-icon" role="img" aria-labelledby="tor-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="tor-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "tor-icon",
    data () {
      let iconTitle = this.title ? this.title : "Tor icon"
