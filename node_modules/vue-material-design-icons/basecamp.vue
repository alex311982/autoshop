<template>
  <div class="material-design-icon" id="basecamp-icon" role="img" aria-labelledby="basecamp-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="basecamp-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "basecamp-icon",
    data () {
      let iconTitle = this.title ? this.title : "Basecamp icon"
