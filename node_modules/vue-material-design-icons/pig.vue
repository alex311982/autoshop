<template>
  <div class="material-design-icon" id="pig-icon" role="img" aria-labelledby="pig-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="pig-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "pig-icon",
    data () {
      let iconTitle = this.title ? this.title : "Pig icon"
