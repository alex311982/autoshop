<template>
  <div class="material-design-icon" id="yeast-icon" role="img" aria-labelledby="yeast-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="yeast-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "yeast-icon",
    data () {
      let iconTitle = this.title ? this.title : "Yeast icon"
