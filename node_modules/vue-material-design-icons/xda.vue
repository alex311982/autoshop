<template>
  <div class="material-design-icon" id="xda-icon" role="img" aria-labelledby="xda-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="xda-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "xda-icon",
    data () {
      let iconTitle = this.title ? this.title : "Xda icon"
