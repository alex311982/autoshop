<template>
  <div class="material-design-icon" id="corn-icon" role="img" aria-labelledby="corn-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="corn-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "corn-icon",
    data () {
      let iconTitle = this.title ? this.title : "Corn icon"
