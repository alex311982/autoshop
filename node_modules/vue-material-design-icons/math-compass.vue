<template>
  <div class="material-design-icon" id="math-compass-icon" role="img" aria-labelledby="math-compass-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="math-compass-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Math compass icon"
