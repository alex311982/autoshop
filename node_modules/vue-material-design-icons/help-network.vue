<template>
  <div class="material-design-icon" id="help-network-icon" role="img" aria-labelledby="help-network-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="help-network-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Help network icon"
