<template>
  <div class="material-design-icon" id="format-rotate-90-icon" role="img" aria-labelledby="format-rotate-90-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="format-rotate-90-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Format rotate 90 icon"
