<template>
  <div class="material-design-icon" id="thought-bubble-outline-icon" role="img" aria-labelledby="thought-bubble-outline-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="thought-bubble-outline-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Thought bubble outline icon"
