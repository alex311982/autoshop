<template>
  <div class="material-design-icon" id="alpha-icon" role="img" aria-labelledby="alpha-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="alpha-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "alpha-icon",
    data () {
      let iconTitle = this.title ? this.title : "Alpha icon"
