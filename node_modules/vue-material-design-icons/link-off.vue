<template>
  <div class="material-design-icon" id="link-off-icon" role="img" aria-labelledby="link-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="link-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "link-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Link off icon"
