<template>
  <div class="material-design-icon" id="vk-circle-icon" role="img" aria-labelledby="vk-circle-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="vk-circle-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "vk-circle-icon",
    data () {
      let iconTitle = this.title ? this.title : "Vk circle icon"
