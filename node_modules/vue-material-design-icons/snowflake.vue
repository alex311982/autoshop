<template>
  <div class="material-design-icon" id="snowflake-icon" role="img" aria-labelledby="snowflake-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="snowflake-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "snowflake-icon",
    data () {
      let iconTitle = this.title ? this.title : "Snowflake icon"
