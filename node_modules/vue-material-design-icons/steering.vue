<template>
  <div class="material-design-icon" id="steering-icon" role="img" aria-labelledby="steering-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="steering-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "steering-icon",
    data () {
      let iconTitle = this.title ? this.title : "Steering icon"
