<template>
  <div class="material-design-icon" id="barcode-icon" role="img" aria-labelledby="barcode-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="barcode-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "barcode-icon",
    data () {
      let iconTitle = this.title ? this.title : "Barcode icon"
