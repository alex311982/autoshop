<template>
  <div class="material-design-icon" id="palette-icon" role="img" aria-labelledby="palette-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="palette-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "palette-icon",
    data () {
      let iconTitle = this.title ? this.title : "Palette icon"
