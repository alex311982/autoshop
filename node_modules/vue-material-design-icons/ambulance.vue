<template>
  <div class="material-design-icon" id="ambulance-icon" role="img" aria-labelledby="ambulance-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="ambulance-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "ambulance-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ambulance icon"
