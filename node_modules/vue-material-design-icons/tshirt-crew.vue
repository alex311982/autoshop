<template>
  <div class="material-design-icon" id="tshirt-crew-icon" role="img" aria-labelledby="tshirt-crew-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="tshirt-crew-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Tshirt crew icon"
