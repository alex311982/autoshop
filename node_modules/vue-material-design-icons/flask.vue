<template>
  <div class="material-design-icon" id="flask-icon" role="img" aria-labelledby="flask-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="flask-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "flask-icon",
    data () {
      let iconTitle = this.title ? this.title : "Flask icon"
