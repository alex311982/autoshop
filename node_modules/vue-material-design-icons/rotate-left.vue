<template>
  <div class="material-design-icon" id="rotate-left-icon" role="img" aria-labelledby="rotate-left-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="rotate-left-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Rotate left icon"
