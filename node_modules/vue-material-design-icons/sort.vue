<template>
  <div class="material-design-icon" id="sort-icon" role="img" aria-labelledby="sort-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="sort-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "sort-icon",
    data () {
      let iconTitle = this.title ? this.title : "Sort icon"
