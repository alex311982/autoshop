<template>
  <div class="material-design-icon" id="panorama-vertical-icon" role="img" aria-labelledby="panorama-vertical-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="panorama-vertical-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Panorama vertical icon"
