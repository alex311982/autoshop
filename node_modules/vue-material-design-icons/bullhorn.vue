<template>
  <div class="material-design-icon" id="bullhorn-icon" role="img" aria-labelledby="bullhorn-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="bullhorn-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "bullhorn-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bullhorn icon"
