<template>
  <div class="material-design-icon" id="etsy-icon" role="img" aria-labelledby="etsy-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="etsy-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "etsy-icon",
    data () {
      let iconTitle = this.title ? this.title : "Etsy icon"
