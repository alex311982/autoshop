<template>
  <div class="material-design-icon" id="pocket-icon" role="img" aria-labelledby="pocket-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="pocket-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "pocket-icon",
    data () {
      let iconTitle = this.title ? this.title : "Pocket icon"
