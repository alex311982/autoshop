<template>
  <div class="material-design-icon" id="baby-buggy-icon" role="img" aria-labelledby="baby-buggy-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="baby-buggy-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Baby buggy icon"
