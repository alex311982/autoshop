<template>
  <div class="material-design-icon" id="checkbox-multiple-blank-circle-outline-icon" role="img" aria-labelledby="checkbox-multiple-blank-circle-outline-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="checkbox-multiple-blank-circle-outline-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Checkbox multiple blank circle outline icon"
