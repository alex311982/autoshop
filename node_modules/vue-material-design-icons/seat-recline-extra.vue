<template>
  <div class="material-design-icon" id="seat-recline-extra-icon" role="img" aria-labelledby="seat-recline-extra-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="seat-recline-extra-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Seat recline extra icon"
