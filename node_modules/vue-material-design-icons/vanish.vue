<template>
  <div class="material-design-icon" id="vanish-icon" role="img" aria-labelledby="vanish-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="vanish-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "vanish-icon",
    data () {
      let iconTitle = this.title ? this.title : "Vanish icon"
