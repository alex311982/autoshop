<template>
  <div class="material-design-icon" id="metronome-tick-icon" role="img" aria-labelledby="metronome-tick-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="metronome-tick-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Metronome tick icon"
