<template>
  <div class="material-design-icon" id="amplifier-icon" role="img" aria-labelledby="amplifier-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="amplifier-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "amplifier-icon",
    data () {
      let iconTitle = this.title ? this.title : "Amplifier icon"
