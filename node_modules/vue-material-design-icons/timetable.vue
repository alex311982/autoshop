<template>
  <div class="material-design-icon" id="timetable-icon" role="img" aria-labelledby="timetable-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="timetable-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "timetable-icon",
    data () {
      let iconTitle = this.title ? this.title : "Timetable icon"
