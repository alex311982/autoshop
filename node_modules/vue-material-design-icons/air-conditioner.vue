<template>
  <div class="material-design-icon" id="air-conditioner-icon" role="img" aria-labelledby="air-conditioner-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="air-conditioner-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Air conditioner icon"
