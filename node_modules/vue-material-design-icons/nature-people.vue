<template>
  <div class="material-design-icon" id="nature-people-icon" role="img" aria-labelledby="nature-people-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="nature-people-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Nature people icon"
