<template>
  <div class="material-design-icon" id="popcorn-icon" role="img" aria-labelledby="popcorn-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="popcorn-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "popcorn-icon",
    data () {
      let iconTitle = this.title ? this.title : "Popcorn icon"
