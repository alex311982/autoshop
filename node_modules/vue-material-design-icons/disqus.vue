<template>
  <div class="material-design-icon" id="disqus-icon" role="img" aria-labelledby="disqus-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="disqus-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "disqus-icon",
    data () {
      let iconTitle = this.title ? this.title : "Disqus icon"
