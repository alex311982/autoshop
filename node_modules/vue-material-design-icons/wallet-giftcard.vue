<template>
  <div class="material-design-icon" id="wallet-giftcard-icon" role="img" aria-labelledby="wallet-giftcard-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="wallet-giftcard-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Wallet giftcard icon"
