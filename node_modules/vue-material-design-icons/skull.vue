<template>
  <div class="material-design-icon" id="skull-icon" role="img" aria-labelledby="skull-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="skull-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "skull-icon",
    data () {
      let iconTitle = this.title ? this.title : "Skull icon"
