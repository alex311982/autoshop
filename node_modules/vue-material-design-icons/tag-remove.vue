<template>
  <div class="material-design-icon" id="tag-remove-icon" role="img" aria-labelledby="tag-remove-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="tag-remove-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Tag remove icon"
