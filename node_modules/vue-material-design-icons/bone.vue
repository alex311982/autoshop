<template>
  <div class="material-design-icon" id="bone-icon" role="img" aria-labelledby="bone-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="bone-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "bone-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bone icon"
