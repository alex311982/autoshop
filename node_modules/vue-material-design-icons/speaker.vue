<template>
  <div class="material-design-icon" id="speaker-icon" role="img" aria-labelledby="speaker-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="speaker-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "speaker-icon",
    data () {
      let iconTitle = this.title ? this.title : "Speaker icon"
