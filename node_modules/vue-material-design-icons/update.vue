<template>
  <div class="material-design-icon" id="update-icon" role="img" aria-labelledby="update-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="update-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "update-icon",
    data () {
      let iconTitle = this.title ? this.title : "Update icon"
