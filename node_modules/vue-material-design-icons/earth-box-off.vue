<template>
  <div class="material-design-icon" id="earth-box-off-icon" role="img" aria-labelledby="earth-box-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="earth-box-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Earth box off icon"
