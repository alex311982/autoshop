<template>
  <div class="material-design-icon" id="human-male-female-icon" role="img" aria-labelledby="human-male-female-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="human-male-female-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Human male female icon"
