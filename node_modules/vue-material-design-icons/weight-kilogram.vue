<template>
  <div class="material-design-icon" id="weight-kilogram-icon" role="img" aria-labelledby="weight-kilogram-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="weight-kilogram-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Weight kilogram icon"
