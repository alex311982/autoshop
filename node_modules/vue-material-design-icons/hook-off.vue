<template>
  <div class="material-design-icon" id="hook-off-icon" role="img" aria-labelledby="hook-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="hook-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "hook-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Hook off icon"
