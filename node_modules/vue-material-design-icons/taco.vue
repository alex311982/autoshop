<template>
  <div class="material-design-icon" id="taco-icon" role="img" aria-labelledby="taco-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="taco-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "taco-icon",
    data () {
      let iconTitle = this.title ? this.title : "Taco icon"
