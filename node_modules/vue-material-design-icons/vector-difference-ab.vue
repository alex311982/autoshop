<template>
  <div class="material-design-icon" id="vector-difference-ab-icon" role="img" aria-labelledby="vector-difference-ab-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="vector-difference-ab-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Vector difference ab icon"
