<template>
  <div class="material-design-icon" id="skype-business-icon" role="img" aria-labelledby="skype-business-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="skype-business-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Skype business icon"
