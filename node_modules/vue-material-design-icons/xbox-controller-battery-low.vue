<template>
  <div class="material-design-icon" id="xbox-controller-battery-low-icon" role="img" aria-labelledby="xbox-controller-battery-low-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="xbox-controller-battery-low-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Xbox controller battery low icon"
