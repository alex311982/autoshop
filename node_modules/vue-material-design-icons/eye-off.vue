<template>
  <div class="material-design-icon" id="eye-off-icon" role="img" aria-labelledby="eye-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="eye-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "eye-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Eye off icon"
