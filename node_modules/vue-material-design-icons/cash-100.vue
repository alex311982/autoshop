<template>
  <div class="material-design-icon" id="cash-100-icon" role="img" aria-labelledby="cash-100-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="cash-100-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "cash-100-icon",
    data () {
      let iconTitle = this.title ? this.title : "Cash 100 icon"
