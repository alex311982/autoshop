<template>
  <div class="material-design-icon" id="gas-station-icon" role="img" aria-labelledby="gas-station-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="gas-station-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Gas station icon"
