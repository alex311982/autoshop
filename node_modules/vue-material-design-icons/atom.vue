<template>
  <div class="material-design-icon" id="atom-icon" role="img" aria-labelledby="atom-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="atom-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "atom-icon",
    data () {
      let iconTitle = this.title ? this.title : "Atom icon"
