<template>
  <div class="material-design-icon" id="lan-icon" role="img" aria-labelledby="lan-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="lan-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "lan-icon",
    data () {
      let iconTitle = this.title ? this.title : "Lan icon"
