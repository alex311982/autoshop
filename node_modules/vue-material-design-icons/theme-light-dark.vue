<template>
  <div class="material-design-icon" id="theme-light-dark-icon" role="img" aria-labelledby="theme-light-dark-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="theme-light-dark-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Theme light dark icon"
