<template>
  <div class="material-design-icon" id="timer-3-icon" role="img" aria-labelledby="timer-3-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="timer-3-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "timer-3-icon",
    data () {
      let iconTitle = this.title ? this.title : "Timer 3 icon"
