<template>
  <div class="material-design-icon" id="kodi-icon" role="img" aria-labelledby="kodi-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="kodi-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "kodi-icon",
    data () {
      let iconTitle = this.title ? this.title : "Kodi icon"
