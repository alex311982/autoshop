<template>
  <div class="material-design-icon" id="database-plus-icon" role="img" aria-labelledby="database-plus-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="database-plus-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Database plus icon"
