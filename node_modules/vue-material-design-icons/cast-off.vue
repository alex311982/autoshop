<template>
  <div class="material-design-icon" id="cast-off-icon" role="img" aria-labelledby="cast-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="cast-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "cast-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Cast off icon"
