<template>
  <div class="material-design-icon" id="rotate-90-icon" role="img" aria-labelledby="rotate-90-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="rotate-90-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "rotate-90-icon",
    data () {
      let iconTitle = this.title ? this.title : "Rotate 90 icon"
