<template>
  <div class="material-design-icon" id="web-icon" role="img" aria-labelledby="web-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="web-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "web-icon",
    data () {
      let iconTitle = this.title ? this.title : "Web icon"
