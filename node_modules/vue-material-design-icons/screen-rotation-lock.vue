<template>
  <div class="material-design-icon" id="screen-rotation-lock-icon" role="img" aria-labelledby="screen-rotation-lock-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="screen-rotation-lock-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Screen rotation lock icon"
