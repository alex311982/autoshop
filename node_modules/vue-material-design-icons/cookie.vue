<template>
  <div class="material-design-icon" id="cookie-icon" role="img" aria-labelledby="cookie-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="cookie-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "cookie-icon",
    data () {
      let iconTitle = this.title ? this.title : "Cookie icon"
