<template>
  <div class="material-design-icon" id="forklift-icon" role="img" aria-labelledby="forklift-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="forklift-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "forklift-icon",
    data () {
      let iconTitle = this.title ? this.title : "Forklift icon"
