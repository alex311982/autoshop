<template>
  <div class="material-design-icon" id="arrow-compress-all-icon" role="img" aria-labelledby="arrow-compress-all-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="arrow-compress-all-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "arrow-compress-all-icon",
    data () {
      let iconTitle = this.title ? this.title : "Arrow compress all icon"
