<template>
  <div class="material-design-icon" id="gender-male-female-icon" role="img" aria-labelledby="gender-male-female-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="gender-male-female-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Gender male female icon"
