<template>
  <div class="material-design-icon" id="ear-hearing-icon" role="img" aria-labelledby="ear-hearing-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="ear-hearing-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ear hearing icon"
