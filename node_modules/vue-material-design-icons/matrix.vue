<template>
  <div class="material-design-icon" id="matrix-icon" role="img" aria-labelledby="matrix-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="matrix-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "matrix-icon",
    data () {
      let iconTitle = this.title ? this.title : "Matrix icon"
