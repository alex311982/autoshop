<template>
  <div class="material-design-icon" id="itunes-icon" role="img" aria-labelledby="itunes-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="itunes-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "itunes-icon",
    data () {
      let iconTitle = this.title ? this.title : "Itunes icon"
