<template>
  <div class="material-design-icon" id="glasses-icon" role="img" aria-labelledby="glasses-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="glasses-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "glasses-icon",
    data () {
      let iconTitle = this.title ? this.title : "Glasses icon"
