<template>
  <div class="material-design-icon" id="carrot-icon" role="img" aria-labelledby="carrot-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="carrot-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "carrot-icon",
    data () {
      let iconTitle = this.title ? this.title : "Carrot icon"
