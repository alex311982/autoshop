<template>
  <div class="material-design-icon" id="linux-icon" role="img" aria-labelledby="linux-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="linux-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "linux-icon",
    data () {
      let iconTitle = this.title ? this.title : "Linux icon"
