<template>
  <div class="material-design-icon" id="incognito-icon" role="img" aria-labelledby="incognito-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="incognito-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "incognito-icon",
    data () {
      let iconTitle = this.title ? this.title : "Incognito icon"
