<template>
  <div class="material-design-icon" id="copyright-icon" role="img" aria-labelledby="copyright-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="copyright-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "copyright-icon",
    data () {
      let iconTitle = this.title ? this.title : "Copyright icon"
