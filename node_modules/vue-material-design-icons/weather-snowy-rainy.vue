<template>
  <div class="material-design-icon" id="weather-snowy-rainy-icon" role="img" aria-labelledby="weather-snowy-rainy-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="weather-snowy-rainy-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Weather snowy rainy icon"
