<template>
  <div class="material-design-icon" id="account-box-outline-icon" role="img" aria-labelledby="account-box-outline-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="account-box-outline-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Account box outline icon"
