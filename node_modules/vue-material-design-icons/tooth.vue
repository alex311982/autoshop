<template>
  <div class="material-design-icon" id="tooth-icon" role="img" aria-labelledby="tooth-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="tooth-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "tooth-icon",
    data () {
      let iconTitle = this.title ? this.title : "Tooth icon"
