<template>
  <div class="material-design-icon" id="music-note-bluetooth-off-icon" role="img" aria-labelledby="music-note-bluetooth-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="music-note-bluetooth-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Music note bluetooth off icon"
