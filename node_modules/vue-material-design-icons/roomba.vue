<template>
  <div class="material-design-icon" id="roomba-icon" role="img" aria-labelledby="roomba-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="roomba-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "roomba-icon",
    data () {
      let iconTitle = this.title ? this.title : "Roomba icon"
