<template>
  <div class="material-design-icon" id="satellite-variant-icon" role="img" aria-labelledby="satellite-variant-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="satellite-variant-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Satellite variant icon"
