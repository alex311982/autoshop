<template>
  <div class="material-design-icon" id="clippy-icon" role="img" aria-labelledby="clippy-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="clippy-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "clippy-icon",
    data () {
      let iconTitle = this.title ? this.title : "Clippy icon"
