<template>
  <div class="material-design-icon" id="lightbulb-on-icon" role="img" aria-labelledby="lightbulb-on-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="lightbulb-on-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Lightbulb on icon"
