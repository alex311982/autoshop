<template>
  <div class="material-design-icon" id="blur-off-icon" role="img" aria-labelledby="blur-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="blur-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "blur-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Blur off icon"
