<template>
  <div class="material-design-icon" id="firefox-icon" role="img" aria-labelledby="firefox-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="firefox-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "firefox-icon",
    data () {
      let iconTitle = this.title ? this.title : "Firefox icon"
