<template>
  <div class="material-design-icon" id="set-left-center-icon" role="img" aria-labelledby="set-left-center-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="set-left-center-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Set left center icon"
