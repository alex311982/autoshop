<template>
  <div class="material-design-icon" id="message-settings-variant-icon" role="img" aria-labelledby="message-settings-variant-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="message-settings-variant-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Message settings variant icon"
