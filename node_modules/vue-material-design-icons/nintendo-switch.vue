<template>
  <div class="material-design-icon" id="nintendo-switch-icon" role="img" aria-labelledby="nintendo-switch-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="nintendo-switch-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Nintendo switch icon"
