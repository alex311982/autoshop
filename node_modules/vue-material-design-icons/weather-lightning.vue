<template>
  <div class="material-design-icon" id="weather-lightning-icon" role="img" aria-labelledby="weather-lightning-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="weather-lightning-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Weather lightning icon"
