<template>
  <div class="material-design-icon" id="tram-icon" role="img" aria-labelledby="tram-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="tram-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "tram-icon",
    data () {
      let iconTitle = this.title ? this.title : "Tram icon"
