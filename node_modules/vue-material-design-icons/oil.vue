<template>
  <div class="material-design-icon" id="oil-icon" role="img" aria-labelledby="oil-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="oil-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "oil-icon",
    data () {
      let iconTitle = this.title ? this.title : "Oil icon"
