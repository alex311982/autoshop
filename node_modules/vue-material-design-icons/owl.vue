<template>
  <div class="material-design-icon" id="owl-icon" role="img" aria-labelledby="owl-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="owl-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "owl-icon",
    data () {
      let iconTitle = this.title ? this.title : "Owl icon"
