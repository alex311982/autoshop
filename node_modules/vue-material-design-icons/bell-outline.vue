<template>
  <div class="material-design-icon" id="bell-outline-icon" role="img" aria-labelledby="bell-outline-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="bell-outline-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Bell outline icon"
