<template>
  <div class="material-design-icon" id="swim-icon" role="img" aria-labelledby="swim-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="swim-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "swim-icon",
    data () {
      let iconTitle = this.title ? this.title : "Swim icon"
