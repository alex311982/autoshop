<template>
  <div class="material-design-icon" id="beta-icon" role="img" aria-labelledby="beta-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="beta-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "beta-icon",
    data () {
      let iconTitle = this.title ? this.title : "Beta icon"
