<template>
  <div class="material-design-icon" id="mouse-variant-icon" role="img" aria-labelledby="mouse-variant-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="mouse-variant-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Mouse variant icon"
