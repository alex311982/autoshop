<template>
  <div class="material-design-icon" id="dumbbell-icon" role="img" aria-labelledby="dumbbell-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="dumbbell-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "dumbbell-icon",
    data () {
      let iconTitle = this.title ? this.title : "Dumbbell icon"
