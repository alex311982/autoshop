<template>
  <div class="material-design-icon" id="mail-ru-icon" role="img" aria-labelledby="mail-ru-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="mail-ru-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "mail-ru-icon",
    data () {
      let iconTitle = this.title ? this.title : "Mail ru icon"
