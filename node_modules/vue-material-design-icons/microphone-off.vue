<template>
  <div class="material-design-icon" id="microphone-off-icon" role="img" aria-labelledby="microphone-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="microphone-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Microphone off icon"
