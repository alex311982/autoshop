<template>
  <div class="material-design-icon" id="candle-icon" role="img" aria-labelledby="candle-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="candle-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "candle-icon",
    data () {
      let iconTitle = this.title ? this.title : "Candle icon"
