<template>
  <div class="material-design-icon" id="chili-hot-icon" role="img" aria-labelledby="chili-hot-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="chili-hot-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "chili-hot-icon",
    data () {
      let iconTitle = this.title ? this.title : "Chili hot icon"
