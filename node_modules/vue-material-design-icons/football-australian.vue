<template>
  <div class="material-design-icon" id="football-australian-icon" role="img" aria-labelledby="football-australian-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="football-australian-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Football australian icon"
