<template>
  <div class="material-design-icon" id="scale-icon" role="img" aria-labelledby="scale-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="scale-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "scale-icon",
    data () {
      let iconTitle = this.title ? this.title : "Scale icon"
