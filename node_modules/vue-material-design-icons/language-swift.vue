<template>
  <div class="material-design-icon" id="language-swift-icon" role="img" aria-labelledby="language-swift-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="language-swift-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Language swift icon"
