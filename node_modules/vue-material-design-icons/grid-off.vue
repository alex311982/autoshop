<template>
  <div class="material-design-icon" id="grid-off-icon" role="img" aria-labelledby="grid-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="grid-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "grid-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Grid off icon"
