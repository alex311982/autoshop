<template>
  <div class="material-design-icon" id="git-icon" role="img" aria-labelledby="git-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="git-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "git-icon",
    data () {
      let iconTitle = this.title ? this.title : "Git icon"
