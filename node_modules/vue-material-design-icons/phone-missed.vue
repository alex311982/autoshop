<template>
  <div class="material-design-icon" id="phone-missed-icon" role="img" aria-labelledby="phone-missed-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="phone-missed-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Phone missed icon"
