<template>
  <div class="material-design-icon" id="bomb-off-icon" role="img" aria-labelledby="bomb-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="bomb-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "bomb-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bomb off icon"
