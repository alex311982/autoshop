<template>
  <div class="material-design-icon" id="chili-medium-icon" role="img" aria-labelledby="chili-medium-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="chili-medium-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Chili medium icon"
