<template>
  <div class="material-design-icon" id="subway-icon" role="img" aria-labelledby="subway-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="subway-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "subway-icon",
    data () {
      let iconTitle = this.title ? this.title : "Subway icon"
