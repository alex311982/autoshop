<template>
  <div class="material-design-icon" id="bomb-icon" role="img" aria-labelledby="bomb-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="bomb-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "bomb-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bomb icon"
