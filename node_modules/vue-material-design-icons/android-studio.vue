<template>
  <div class="material-design-icon" id="android-studio-icon" role="img" aria-labelledby="android-studio-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="android-studio-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android studio icon"
