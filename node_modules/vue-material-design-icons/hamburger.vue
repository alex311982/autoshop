<template>
  <div class="material-design-icon" id="hamburger-icon" role="img" aria-labelledby="hamburger-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="hamburger-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "hamburger-icon",
    data () {
      let iconTitle = this.title ? this.title : "Hamburger icon"
