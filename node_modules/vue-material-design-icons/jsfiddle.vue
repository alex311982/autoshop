<template>
  <div class="material-design-icon" id="jsfiddle-icon" role="img" aria-labelledby="jsfiddle-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="jsfiddle-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "jsfiddle-icon",
    data () {
      let iconTitle = this.title ? this.title : "Jsfiddle icon"
