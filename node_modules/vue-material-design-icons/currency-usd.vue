<template>
  <div class="material-design-icon" id="currency-usd-icon" role="img" aria-labelledby="currency-usd-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="currency-usd-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Currency usd icon"
