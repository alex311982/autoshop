<template>
  <div class="material-design-icon" id="lock-icon" role="img" aria-labelledby="lock-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="lock-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "lock-icon",
    data () {
      let iconTitle = this.title ? this.title : "Lock icon"
