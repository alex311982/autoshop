<template>
  <div class="material-design-icon" id="ornament-icon" role="img" aria-labelledby="ornament-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="ornament-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "ornament-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ornament icon"
