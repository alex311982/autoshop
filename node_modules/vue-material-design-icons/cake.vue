<template>
  <div class="material-design-icon" id="cake-icon" role="img" aria-labelledby="cake-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="cake-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "cake-icon",
    data () {
      let iconTitle = this.title ? this.title : "Cake icon"
