<template>
  <div class="material-design-icon" id="camera-metering-center-icon" role="img" aria-labelledby="camera-metering-center-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="camera-metering-center-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Camera metering center icon"
