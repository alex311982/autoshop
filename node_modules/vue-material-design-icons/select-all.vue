<template>
  <div class="material-design-icon" id="select-all-icon" role="img" aria-labelledby="select-all-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="select-all-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Select all icon"
