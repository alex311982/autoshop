<template>
  <div class="material-design-icon" id="hanger-icon" role="img" aria-labelledby="hanger-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="hanger-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "hanger-icon",
    data () {
      let iconTitle = this.title ? this.title : "Hanger icon"
