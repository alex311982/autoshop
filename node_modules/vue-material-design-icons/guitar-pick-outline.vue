<template>
  <div class="material-design-icon" id="guitar-pick-outline-icon" role="img" aria-labelledby="guitar-pick-outline-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="guitar-pick-outline-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Guitar pick outline icon"
