<template>
  <div class="material-design-icon" id="nfc-icon" role="img" aria-labelledby="nfc-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="nfc-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "nfc-icon",
    data () {
      let iconTitle = this.title ? this.title : "Nfc icon"
