<template>
  <div class="material-design-icon" id="onedrive-icon" role="img" aria-labelledby="onedrive-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="onedrive-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "onedrive-icon",
    data () {
      let iconTitle = this.title ? this.title : "Onedrive icon"
