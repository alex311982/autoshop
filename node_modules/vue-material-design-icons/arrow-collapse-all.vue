<template>
  <div class="material-design-icon" id="arrow-collapse-all-icon" role="img" aria-labelledby="arrow-collapse-all-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="arrow-collapse-all-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "arrow-collapse-all-icon",
    data () {
      let iconTitle = this.title ? this.title : "Arrow collapse all icon"
