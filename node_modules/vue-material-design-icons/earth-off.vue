<template>
  <div class="material-design-icon" id="earth-off-icon" role="img" aria-labelledby="earth-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="earth-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "earth-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Earth off icon"
