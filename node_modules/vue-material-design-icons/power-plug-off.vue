<template>
  <div class="material-design-icon" id="power-plug-off-icon" role="img" aria-labelledby="power-plug-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="power-plug-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Power plug off icon"
