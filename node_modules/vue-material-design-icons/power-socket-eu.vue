<template>
  <div class="material-design-icon" id="power-socket-eu-icon" role="img" aria-labelledby="power-socket-eu-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="power-socket-eu-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Power socket eu icon"
