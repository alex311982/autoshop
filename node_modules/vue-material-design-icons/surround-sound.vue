<template>
  <div class="material-design-icon" id="surround-sound-icon" role="img" aria-labelledby="surround-sound-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="surround-sound-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Surround sound icon"
