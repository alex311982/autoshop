<template>
  <div class="material-design-icon" id="xing-circle-icon" role="img" aria-labelledby="xing-circle-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="xing-circle-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Xing circle icon"
