<template>
  <div class="material-design-icon" id="seat-recline-normal-icon" role="img" aria-labelledby="seat-recline-normal-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="seat-recline-normal-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Seat recline normal icon"
