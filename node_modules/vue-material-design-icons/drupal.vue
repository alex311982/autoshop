<template>
  <div class="material-design-icon" id="drupal-icon" role="img" aria-labelledby="drupal-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="drupal-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "drupal-icon",
    data () {
      let iconTitle = this.title ? this.title : "Drupal icon"
