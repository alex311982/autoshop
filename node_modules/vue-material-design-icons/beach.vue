<template>
  <div class="material-design-icon" id="beach-icon" role="img" aria-labelledby="beach-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="beach-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "beach-icon",
    data () {
      let iconTitle = this.title ? this.title : "Beach icon"
