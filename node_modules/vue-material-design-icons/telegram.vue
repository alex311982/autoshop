<template>
  <div class="material-design-icon" id="telegram-icon" role="img" aria-labelledby="telegram-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="telegram-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "telegram-icon",
    data () {
      let iconTitle = this.title ? this.title : "Telegram icon"
