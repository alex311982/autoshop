<template>
  <div class="material-design-icon" id="screen-rotation-icon" role="img" aria-labelledby="screen-rotation-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="screen-rotation-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Screen rotation icon"
