<template>
  <div class="material-design-icon" id="kettle-icon" role="img" aria-labelledby="kettle-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="kettle-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "kettle-icon",
    data () {
      let iconTitle = this.title ? this.title : "Kettle icon"
