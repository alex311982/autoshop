<template>
  <div class="material-design-icon" id="bike-icon" role="img" aria-labelledby="bike-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="bike-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "bike-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bike icon"
