<template>
  <div class="material-design-icon" id="image-filter-vintage-icon" role="img" aria-labelledby="image-filter-vintage-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="image-filter-vintage-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Image filter vintage icon"
