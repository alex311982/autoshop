<template>
  <div class="material-design-icon" id="cloud-sync-icon" role="img" aria-labelledby="cloud-sync-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="cloud-sync-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Cloud sync icon"
