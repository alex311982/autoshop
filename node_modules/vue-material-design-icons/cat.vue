<template>
  <div class="material-design-icon" id="cat-icon" role="img" aria-labelledby="cat-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="cat-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "cat-icon",
    data () {
      let iconTitle = this.title ? this.title : "Cat icon"
