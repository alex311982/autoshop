<template>
  <div class="material-design-icon" id="evernote-icon" role="img" aria-labelledby="evernote-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="evernote-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "evernote-icon",
    data () {
      let iconTitle = this.title ? this.title : "Evernote icon"
