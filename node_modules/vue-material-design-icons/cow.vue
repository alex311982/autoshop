<template>
  <div class="material-design-icon" id="cow-icon" role="img" aria-labelledby="cow-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="cow-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "cow-icon",
    data () {
      let iconTitle = this.title ? this.title : "Cow icon"
