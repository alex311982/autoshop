<template>
  <div class="material-design-icon" id="remote-icon" role="img" aria-labelledby="remote-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="remote-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "remote-icon",
    data () {
      let iconTitle = this.title ? this.title : "Remote icon"
