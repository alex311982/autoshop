<template>
  <div class="material-design-icon" id="close-circle-outline-icon" role="img" aria-labelledby="close-circle-outline-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="close-circle-outline-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Close circle outline icon"
