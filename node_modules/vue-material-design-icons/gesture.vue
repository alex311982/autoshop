<template>
  <div class="material-design-icon" id="gesture-icon" role="img" aria-labelledby="gesture-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="gesture-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "gesture-icon",
    data () {
      let iconTitle = this.title ? this.title : "Gesture icon"
