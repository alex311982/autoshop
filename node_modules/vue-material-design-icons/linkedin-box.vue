<template>
  <div class="material-design-icon" id="linkedin-box-icon" role="img" aria-labelledby="linkedin-box-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="linkedin-box-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Linkedin box icon"
