<template>
  <div class="material-design-icon" id="sticker-icon" role="img" aria-labelledby="sticker-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="sticker-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "sticker-icon",
    data () {
      let iconTitle = this.title ? this.title : "Sticker icon"
