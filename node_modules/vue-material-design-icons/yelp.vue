<template>
  <div class="material-design-icon" id="yelp-icon" role="img" aria-labelledby="yelp-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="yelp-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "yelp-icon",
    data () {
      let iconTitle = this.title ? this.title : "Yelp icon"
