<template>
  <div class="material-design-icon" id="vlc-icon" role="img" aria-labelledby="vlc-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="vlc-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "vlc-icon",
    data () {
      let iconTitle = this.title ? this.title : "Vlc icon"
