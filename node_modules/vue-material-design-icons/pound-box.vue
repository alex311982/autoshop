<template>
  <div class="material-design-icon" id="pound-box-icon" role="img" aria-labelledby="pound-box-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="pound-box-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "pound-box-icon",
    data () {
      let iconTitle = this.title ? this.title : "Pound box icon"
