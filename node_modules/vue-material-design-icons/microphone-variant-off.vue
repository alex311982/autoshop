<template>
  <div class="material-design-icon" id="microphone-variant-off-icon" role="img" aria-labelledby="microphone-variant-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="microphone-variant-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Microphone variant off icon"
