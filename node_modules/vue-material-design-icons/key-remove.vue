<template>
  <div class="material-design-icon" id="key-remove-icon" role="img" aria-labelledby="key-remove-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="key-remove-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Key remove icon"
