<template>
  <div class="material-design-icon" id="webpack-icon" role="img" aria-labelledby="webpack-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="webpack-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "webpack-icon",
    data () {
      let iconTitle = this.title ? this.title : "Webpack icon"
