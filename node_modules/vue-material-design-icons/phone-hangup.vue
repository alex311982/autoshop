<template>
  <div class="material-design-icon" id="phone-hangup-icon" role="img" aria-labelledby="phone-hangup-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="phone-hangup-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Phone hangup icon"
