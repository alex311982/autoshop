<template>
  <div class="material-design-icon" id="vector-difference-ba-icon" role="img" aria-labelledby="vector-difference-ba-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="vector-difference-ba-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Vector difference ba icon"
