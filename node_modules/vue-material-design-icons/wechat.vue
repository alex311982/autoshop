<template>
  <div class="material-design-icon" id="wechat-icon" role="img" aria-labelledby="wechat-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="wechat-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "wechat-icon",
    data () {
      let iconTitle = this.title ? this.title : "Wechat icon"
