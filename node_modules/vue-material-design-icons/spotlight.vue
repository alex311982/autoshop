<template>
  <div class="material-design-icon" id="spotlight-icon" role="img" aria-labelledby="spotlight-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="spotlight-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "spotlight-icon",
    data () {
      let iconTitle = this.title ? this.title : "Spotlight icon"
