<template>
  <div class="material-design-icon" id="bullseye-icon" role="img" aria-labelledby="bullseye-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="bullseye-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "bullseye-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bullseye icon"
