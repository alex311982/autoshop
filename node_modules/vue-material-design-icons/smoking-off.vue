<template>
  <div class="material-design-icon" id="smoking-off-icon" role="img" aria-labelledby="smoking-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="smoking-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Smoking off icon"
