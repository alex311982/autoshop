<template>
  <div class="material-design-icon" id="pistol-icon" role="img" aria-labelledby="pistol-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="pistol-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "pistol-icon",
    data () {
      let iconTitle = this.title ? this.title : "Pistol icon"
