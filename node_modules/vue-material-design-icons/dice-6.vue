<template>
  <div class="material-design-icon" id="dice-6-icon" role="img" aria-labelledby="dice-6-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="dice-6-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "dice-6-icon",
    data () {
      let iconTitle = this.title ? this.title : "Dice 6 icon"
