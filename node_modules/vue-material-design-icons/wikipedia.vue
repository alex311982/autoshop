<template>
  <div class="material-design-icon" id="wikipedia-icon" role="img" aria-labelledby="wikipedia-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="wikipedia-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "wikipedia-icon",
    data () {
      let iconTitle = this.title ? this.title : "Wikipedia icon"
