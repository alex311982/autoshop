<template>
  <div class="material-design-icon" id="select-icon" role="img" aria-labelledby="select-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="select-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "select-icon",
    data () {
      let iconTitle = this.title ? this.title : "Select icon"
