<template>
  <div class="material-design-icon" id="currency-gbp-icon" role="img" aria-labelledby="currency-gbp-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="currency-gbp-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Currency gbp icon"
