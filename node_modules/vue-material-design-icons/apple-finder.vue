<template>
  <div class="material-design-icon" id="apple-finder-icon" role="img" aria-labelledby="apple-finder-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="apple-finder-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Apple finder icon"
