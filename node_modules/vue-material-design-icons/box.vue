<template>
  <div class="material-design-icon" id="box-icon" role="img" aria-labelledby="box-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="box-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "box-icon",
    data () {
      let iconTitle = this.title ? this.title : "Box icon"
