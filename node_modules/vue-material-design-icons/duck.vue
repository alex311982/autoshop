<template>
  <div class="material-design-icon" id="duck-icon" role="img" aria-labelledby="duck-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="duck-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "duck-icon",
    data () {
      let iconTitle = this.title ? this.title : "Duck icon"
