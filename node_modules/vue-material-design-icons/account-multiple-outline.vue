<template>
  <div class="material-design-icon" id="account-multiple-outline-icon" role="img" aria-labelledby="account-multiple-outline-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="account-multiple-outline-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Account multiple outline icon"
