<template>
  <div class="material-design-icon" id="alarm-snooze-icon" role="img" aria-labelledby="alarm-snooze-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="alarm-snooze-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Alarm snooze icon"
