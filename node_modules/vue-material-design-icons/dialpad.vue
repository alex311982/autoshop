<template>
  <div class="material-design-icon" id="dialpad-icon" role="img" aria-labelledby="dialpad-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="dialpad-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "dialpad-icon",
    data () {
      let iconTitle = this.title ? this.title : "Dialpad icon"
