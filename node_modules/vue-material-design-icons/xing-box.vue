<template>
  <div class="material-design-icon" id="xing-box-icon" role="img" aria-labelledby="xing-box-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="xing-box-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "xing-box-icon",
    data () {
      let iconTitle = this.title ? this.title : "Xing box icon"
