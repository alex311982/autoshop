<template>
  <div class="material-design-icon" id="paper-cut-vertical-icon" role="img" aria-labelledby="paper-cut-vertical-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="paper-cut-vertical-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Paper cut vertical icon"
