<template>
  <div class="material-design-icon" id="av-timer-icon" role="img" aria-labelledby="av-timer-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="av-timer-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "av-timer-icon",
    data () {
      let iconTitle = this.title ? this.title : "Av timer icon"
