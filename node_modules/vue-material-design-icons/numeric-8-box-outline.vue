<template>
  <div class="material-design-icon" id="numeric-8-box-outline-icon" role="img" aria-labelledby="numeric-8-box-outline-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="numeric-8-box-outline-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Numeric 8 box outline icon"
