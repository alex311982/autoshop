<template>
  <div class="material-design-icon" id="codepen-icon" role="img" aria-labelledby="codepen-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="codepen-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "codepen-icon",
    data () {
      let iconTitle = this.title ? this.title : "Codepen icon"
