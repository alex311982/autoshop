<template>
  <div class="material-design-icon" id="coins-icon" role="img" aria-labelledby="coins-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="coins-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "coins-icon",
    data () {
      let iconTitle = this.title ? this.title : "Coins icon"
