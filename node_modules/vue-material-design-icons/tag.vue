<template>
  <div class="material-design-icon" id="tag-icon" role="img" aria-labelledby="tag-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="tag-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "tag-icon",
    data () {
      let iconTitle = this.title ? this.title : "Tag icon"
