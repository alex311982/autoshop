<template>
  <div class="material-design-icon" id="webcam-icon" role="img" aria-labelledby="webcam-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="webcam-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "webcam-icon",
    data () {
      let iconTitle = this.title ? this.title : "Webcam icon"
