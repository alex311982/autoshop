<template>
  <div class="material-design-icon" id="car-convertable-icon" role="img" aria-labelledby="car-convertable-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="car-convertable-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "car-convertable-icon",
    data () {
      let iconTitle = this.title ? this.title : "Car convertable icon"
