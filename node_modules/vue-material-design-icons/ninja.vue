<template>
  <div class="material-design-icon" id="ninja-icon" role="img" aria-labelledby="ninja-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="ninja-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "ninja-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ninja icon"
