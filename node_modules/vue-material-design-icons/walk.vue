<template>
  <div class="material-design-icon" id="walk-icon" role="img" aria-labelledby="walk-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="walk-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "walk-icon",
    data () {
      let iconTitle = this.title ? this.title : "Walk icon"
