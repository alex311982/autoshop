<template>
  <div class="material-design-icon" id="file-find-icon" role="img" aria-labelledby="file-find-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="file-find-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "file-find-icon",
    data () {
      let iconTitle = this.title ? this.title : "File find icon"
