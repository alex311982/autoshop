<template>
  <div class="material-design-icon" id="transit-transfer-icon" role="img" aria-labelledby="transit-transfer-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="transit-transfer-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Transit transfer icon"
