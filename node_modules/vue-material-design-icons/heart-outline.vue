<template>
  <div class="material-design-icon" id="heart-outline-icon" role="img" aria-labelledby="heart-outline-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="heart-outline-icon-title">{{iconTitle}}</title>
