<template>
  <div class="material-design-icon" id="access-point-network-icon" role="img" aria-labelledby="access-point-network-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="access-point-network-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Access point network icon"
