<template>
  <div class="material-design-icon" id="ubuntu-icon" role="img" aria-labelledby="ubuntu-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="ubuntu-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "ubuntu-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ubuntu icon"
