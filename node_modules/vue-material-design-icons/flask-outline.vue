<template>
  <div class="material-design-icon" id="flask-outline-icon" role="img" aria-labelledby="flask-outline-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="flask-outline-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Flask outline icon"
