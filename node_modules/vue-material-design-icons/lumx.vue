<template>
  <div class="material-design-icon" id="lumx-icon" role="img" aria-labelledby="lumx-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="lumx-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "lumx-icon",
    data () {
      let iconTitle = this.title ? this.title : "Lumx icon"
