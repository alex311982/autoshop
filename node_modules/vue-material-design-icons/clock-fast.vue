<template>
  <div class="material-design-icon" id="clock-fast-icon" role="img" aria-labelledby="clock-fast-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="clock-fast-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Clock fast icon"
