<template>
  <div class="material-design-icon" id="google-wallet-icon" role="img" aria-labelledby="google-wallet-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="google-wallet-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Google wallet icon"
