<template>
  <div class="material-design-icon" id="regex-icon" role="img" aria-labelledby="regex-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="regex-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "regex-icon",
    data () {
      let iconTitle = this.title ? this.title : "Regex icon"
