<template>
  <div class="material-design-icon" id="cart-icon" role="img" aria-labelledby="cart-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="cart-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "cart-icon",
    data () {
      let iconTitle = this.title ? this.title : "Cart icon"
