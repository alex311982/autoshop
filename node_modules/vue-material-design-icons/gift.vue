<template>
  <div class="material-design-icon" id="gift-icon" role="img" aria-labelledby="gift-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="gift-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "gift-icon",
    data () {
      let iconTitle = this.title ? this.title : "Gift icon"
