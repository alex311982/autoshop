<template>
  <div class="material-design-icon" id="car-sports-icon" role="img" aria-labelledby="car-sports-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="car-sports-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Car sports icon"
