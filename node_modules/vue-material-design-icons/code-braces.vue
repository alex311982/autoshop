<template>
  <div class="material-design-icon" id="code-braces-icon" role="img" aria-labelledby="code-braces-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="code-braces-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Code braces icon"
