<template>
  <div class="material-design-icon" id="traffic-light-icon" role="img" aria-labelledby="traffic-light-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="traffic-light-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Traffic light icon"
