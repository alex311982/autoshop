<template>
  <div class="material-design-icon" id="stove-icon" role="img" aria-labelledby="stove-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="stove-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "stove-icon",
    data () {
      let iconTitle = this.title ? this.title : "Stove icon"
