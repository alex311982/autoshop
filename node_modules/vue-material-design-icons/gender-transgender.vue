<template>
  <div class="material-design-icon" id="gender-transgender-icon" role="img" aria-labelledby="gender-transgender-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="gender-transgender-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Gender transgender icon"
