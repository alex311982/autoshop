<template>
  <div class="material-design-icon" id="behance-icon" role="img" aria-labelledby="behance-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="behance-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "behance-icon",
    data () {
      let iconTitle = this.title ? this.title : "Behance icon"
