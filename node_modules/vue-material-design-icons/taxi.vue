<template>
  <div class="material-design-icon" id="taxi-icon" role="img" aria-labelledby="taxi-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="taxi-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "taxi-icon",
    data () {
      let iconTitle = this.title ? this.title : "Taxi icon"
