<template>
  <div class="material-design-icon" id="hexagon-multiple-icon" role="img" aria-labelledby="hexagon-multiple-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="hexagon-multiple-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Hexagon multiple icon"
