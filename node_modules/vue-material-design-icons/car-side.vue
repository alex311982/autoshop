<template>
  <div class="material-design-icon" id="car-side-icon" role="img" aria-labelledby="car-side-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="car-side-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "car-side-icon",
    data () {
      let iconTitle = this.title ? this.title : "Car side icon"
