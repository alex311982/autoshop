<template>
  <div class="material-design-icon" id="barley-icon" role="img" aria-labelledby="barley-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="barley-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "barley-icon",
    data () {
      let iconTitle = this.title ? this.title : "Barley icon"
