<template>
  <div class="material-design-icon" id="pool-icon" role="img" aria-labelledby="pool-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="pool-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "pool-icon",
    data () {
      let iconTitle = this.title ? this.title : "Pool icon"
