<template>
  <div class="material-design-icon" id="gesture-double-tap-icon" role="img" aria-labelledby="gesture-double-tap-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="gesture-double-tap-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Gesture double tap icon"
