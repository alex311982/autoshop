<template>
  <div class="material-design-icon" id="vpn-icon" role="img" aria-labelledby="vpn-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="vpn-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "vpn-icon",
    data () {
      let iconTitle = this.title ? this.title : "Vpn icon"
