<template>
  <div class="material-design-icon" id="directions-fork-icon" role="img" aria-labelledby="directions-fork-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="directions-fork-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "directions-fork-icon",
    data () {
      let iconTitle = this.title ? this.title : "Directions fork icon"
