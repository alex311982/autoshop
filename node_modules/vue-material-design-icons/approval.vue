<template>
  <div class="material-design-icon" id="approval-icon" role="img" aria-labelledby="approval-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="approval-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "approval-icon",
    data () {
      let iconTitle = this.title ? this.title : "Approval icon"
