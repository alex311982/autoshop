<template>
  <div class="material-design-icon" id="emoticon-neutral-icon" role="img" aria-labelledby="emoticon-neutral-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="emoticon-neutral-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Emoticon neutral icon"
