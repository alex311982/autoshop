<template>
  <div class="material-design-icon" id="fax-icon" role="img" aria-labelledby="fax-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="fax-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "fax-icon",
    data () {
      let iconTitle = this.title ? this.title : "Fax icon"
