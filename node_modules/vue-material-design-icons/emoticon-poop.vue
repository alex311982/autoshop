<template>
  <div class="material-design-icon" id="emoticon-poop-icon" role="img" aria-labelledby="emoticon-poop-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="emoticon-poop-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Emoticon poop icon"
