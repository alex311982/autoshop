<template>
  <div class="material-design-icon" id="heart-pulse-icon" role="img" aria-labelledby="heart-pulse-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="heart-pulse-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Heart pulse icon"
