<template>
  <div class="material-design-icon" id="ruler-icon" role="img" aria-labelledby="ruler-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="ruler-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "ruler-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ruler icon"
