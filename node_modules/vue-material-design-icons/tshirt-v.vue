<template>
  <div class="material-design-icon" id="tshirt-v-icon" role="img" aria-labelledby="tshirt-v-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="tshirt-v-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "tshirt-v-icon",
    data () {
      let iconTitle = this.title ? this.title : "Tshirt v icon"
