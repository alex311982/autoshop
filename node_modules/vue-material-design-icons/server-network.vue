<template>
  <div class="material-design-icon" id="server-network-icon" role="img" aria-labelledby="server-network-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="server-network-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Server network icon"
