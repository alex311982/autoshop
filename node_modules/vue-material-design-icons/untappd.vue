<template>
  <div class="material-design-icon" id="untappd-icon" role="img" aria-labelledby="untappd-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="untappd-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "untappd-icon",
    data () {
      let iconTitle = this.title ? this.title : "Untappd icon"
