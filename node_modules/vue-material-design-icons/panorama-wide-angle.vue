<template>
  <div class="material-design-icon" id="panorama-wide-angle-icon" role="img" aria-labelledby="panorama-wide-angle-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="panorama-wide-angle-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Panorama wide angle icon"
