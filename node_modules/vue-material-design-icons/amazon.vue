<template>
  <div class="material-design-icon" id="amazon-icon" role="img" aria-labelledby="amazon-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="amazon-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "amazon-icon",
    data () {
      let iconTitle = this.title ? this.title : "Amazon icon"
