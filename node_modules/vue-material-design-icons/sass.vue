<template>
  <div class="material-design-icon" id="sass-icon" role="img" aria-labelledby="sass-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="sass-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "sass-icon",
    data () {
      let iconTitle = this.title ? this.title : "Sass icon"
