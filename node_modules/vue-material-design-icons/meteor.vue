<template>
  <div class="material-design-icon" id="meteor-icon" role="img" aria-labelledby="meteor-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="meteor-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "meteor-icon",
    data () {
      let iconTitle = this.title ? this.title : "Meteor icon"
