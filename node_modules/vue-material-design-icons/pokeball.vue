<template>
  <div class="material-design-icon" id="pokeball-icon" role="img" aria-labelledby="pokeball-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="pokeball-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "pokeball-icon",
    data () {
      let iconTitle = this.title ? this.title : "Pokeball icon"
