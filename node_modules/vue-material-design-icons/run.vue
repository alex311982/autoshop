<template>
  <div class="material-design-icon" id="run-icon" role="img" aria-labelledby="run-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="run-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "run-icon",
    data () {
      let iconTitle = this.title ? this.title : "Run icon"
