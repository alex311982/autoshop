<template>
  <div class="material-design-icon" id="led-strip-icon" role="img" aria-labelledby="led-strip-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="led-strip-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "led-strip-icon",
    data () {
      let iconTitle = this.title ? this.title : "Led strip icon"
