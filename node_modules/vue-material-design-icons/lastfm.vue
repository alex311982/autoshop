<template>
  <div class="material-design-icon" id="lastfm-icon" role="img" aria-labelledby="lastfm-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="lastfm-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "lastfm-icon",
    data () {
      let iconTitle = this.title ? this.title : "Lastfm icon"
