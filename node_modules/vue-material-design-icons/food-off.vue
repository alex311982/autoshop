<template>
  <div class="material-design-icon" id="food-off-icon" role="img" aria-labelledby="food-off-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="food-off-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "food-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Food off icon"
