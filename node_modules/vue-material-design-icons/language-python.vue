<template>
  <div class="material-design-icon" id="language-python-icon" role="img" aria-labelledby="language-python-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="language-python-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Language python icon"
