<template>
  <div class="material-design-icon" id="json-icon" role="img" aria-labelledby="json-icon-title">
    <svg class="material-design-icon__svg" width="24" height="24" viewBox="0 0 24 24">
      <title id="json-icon-title">{{iconTitle}}</title>
...
<script>
  export default {
    name: "json-icon",
    data () {
      let iconTitle = this.title ? this.title : "Json icon"
